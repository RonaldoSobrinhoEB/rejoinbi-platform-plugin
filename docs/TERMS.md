...
This plugin is provided as-is. Review dry-run output, generated files, and production changes before relying on them in critical environments.
...
The plugin may change over time as Rejoin BI APIs and Codex plugin requirements evolve. Review release commits before installing updates in production environments.
