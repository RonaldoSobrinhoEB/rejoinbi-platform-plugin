...
python "$HOME\plugins\rejoinbi-platform\scripts\rejoinbi.py" --tenant subdomain.rejoinbi.com.br set-platform-config --browser-title "Minha BI" --logo-image-file C:\path\logo.png
