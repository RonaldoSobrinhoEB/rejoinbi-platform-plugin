...
| `workspace` | Workspace lifecycle and configuration | `workspace*`, `create-workspace`, `update-workspace`, `delete-workspace`, `validate-workspace`, `remove-file` |
